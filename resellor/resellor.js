...
const setupReveal = () => {
  const nodes = document.querySelectorAll(
    ".resellor-hero__copy, .resellor-proof__grid div, .platform-stack article, .channel-card, .reseller-flow__grid article, .model-card, .dashboard-media, .reason-list article, .resellor-cta__inner"
  );
...
const setupResellorHeroCarousel = () => {
  const slides = Array.from(document.querySelectorAll(".resellor-hero-carousel__slide"));
  const dots = Array.from(document.querySelectorAll("[data-resellor-hero-dot]"));
