...
const setupReveal = () => {
  const nodes = document.querySelectorAll(
    ".institute-hero__copy, .institute-proof__grid div, .institute-marquee__inner, .readiness__grid > div, .readiness-panel article, .stage-card, .solution-media, .solution-list article, .institute-cta__inner"
  );
...
const setupInstituteHeroCarousel = () => {
  const slides = Array.from(document.querySelectorAll(".institute-hero-carousel__slide"));
  const dots = Array.from(document.querySelectorAll("[data-institute-hero-dot]"));
