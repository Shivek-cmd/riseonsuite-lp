...
const setupReveal = () => {
  const nodes = document.querySelectorAll(
    ".partner-hero__copy, .partner-proof__grid div, .industry-strip span, .flow-card, .solution-media, .solution-list article, .partner-cta__inner"
  );
...
const setupPartnerHeroCarousel = () => {
  const slides = Array.from(document.querySelectorAll(".partner-hero-carousel__slide"));
  const dots = Array.from(document.querySelectorAll("[data-partner-hero-dot]"));
